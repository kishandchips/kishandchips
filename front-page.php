...
<section id="front-page" class="clearfix">
	...
	if($query->have_posts()):
		...
		$gallery_page_id = get_kishandchips_option('gallery_page_id');
	?>
	<div id="photos">
		<div class="inner container">
			...
			<footer class="photos-footer">
				<p class="no-margin">
					<a href="<?php echo get_permalink(get_kishandchips_option('submit_photo_page_id')); ?>" class="uppercase"><i aria-hidden="true" class="icon-camera big text-middle"></i>&nbsp;&nbsp;<?php _e("Send a photo for the gallery", 'kishandchips') ?></a>
				</p>
